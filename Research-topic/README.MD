...
In this section we will describe how to set up and initialize the development environment for a single Vagrant virtual machine. We will also briefly describe the main Vagrant components.
